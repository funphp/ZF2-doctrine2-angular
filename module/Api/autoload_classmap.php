...
return array(
	...
	'Api\Controller\InfoController' => __DIR__ . '/src/Api/Controller/InfoController.php',
        'Api\Controller\GoalController' => __DIR__ . '/src/Api/Controller/GoalController.php',
);
